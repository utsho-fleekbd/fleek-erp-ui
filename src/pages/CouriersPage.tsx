...
const performanceData = couriers
...
const zones = [
  { id: 1, name: "Metro Area", cities: 12, baseCost: 5.99, perKg: 0.5 },
  { id: 2, name: "Suburban", cities: 28, baseCost: 8.99, perKg: 0.75 },
  { id: 3, name: "Rural", cities: 45, baseCost: 12.99, perKg: 1.2 },
  { id: 4, name: "Remote", cities: 15, baseCost: 18.99, perKg: 2.0 },
];
    ...
    <AppLayout>
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Manage shipping and payment gateways
        </p>
      </div>
