      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <Card className="border-border bg-card">
          <CardContent className="space-y-4 p-6">
            ...
            <Link to="/"><Button className="w-full">Sign In</Button></Link>
            <p className="text-center text-xs text-muted-foreground">Don't have an account? <Link to="/register" className="text-primary hover:underline">Sign up</Link></p>
          </CardContent>
        </Card>
      </div>
    </div>
