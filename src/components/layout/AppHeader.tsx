...
const notifications = [
  {
    ...
    desc: "Order #ORD-7291 from Sarah Chen",
    time: "2 min ago",
    read: false,
  },
  {
    ...
    desc: "Smart Watch Pro is running low (5 units)",
    time: "15 min ago",
    read: false,
  },
  {
  ...
  },
  {
    ...
    desc: "Order #ORD-7286 delivered successfully",
    time: "2 hours ago",
    read: true,
  },
];
    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-4 lg:px-6 transition-all duration-300">
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="hidden h-9 w-9 text-muted-foreground sm:flex"
          ...
          <PopoverContent align="end" className="w-80 p-0">
            ...
            <ScrollArea className="max-h-72 w-full overflow-auto">
              {notifications.map((n) => (
                <div
                  key={n.id}
                  className={`flex gap-3 border-b border-border px-4 py-3 last:border-0 transition-colors ${!n.read ? "bg-secondary/50" : ""}`}
                >
                  <div
                    className={`mt-1 h-2 w-2 shrink-0 rounded-full ${!n.read ? "bg-primary" : "bg-transparent"}`}
                  />
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuItem className="gap-2">
              <div className="flex h-6 w-6 items-center justify-center rounded bg-success text-[10px] font-bold text-success-foreground">
                G
              </div>
              <div>
